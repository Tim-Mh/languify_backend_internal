@include('emails.partials.shell-open', ['emailTitle' => 'New Family Member'])
...
<tr>
  <td class="px" align="center" style="padding: 20px 48px 8px;">
    ...
    <p style="margin:0; font-size:15px; line-height:1.6; color:#613f88;">
      Hi {{ $ownerName }}, {{ $memberEmail }} just accepted your invite and now has full Family plan access: unlimited hearts, bonus gems, and no ads.
    </p>
  </td>
</tr>
...
@include('emails.partials.shell-close', ['footerNote' => 'Sent because you own a Languify Family plan.'])
