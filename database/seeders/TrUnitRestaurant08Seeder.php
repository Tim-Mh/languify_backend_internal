...
class TrUnitRestaurant08Seeder extends Seeder
{
    ...
    /**
     * Turkish Restaurant Unit 8 - what comes after.
     *
     * THE RULE THIS UNIT TEACHES: `tatlı` IS BOTH A NOUN AND AN ADJECTIVE.
     *
     * The same word means "dessert" and "sweet", and Turkish does not change its
     * shape for either job. Which one it is comes entirely from position: before a
     * noun it describes, alone it names.
     *
     *     tatlı istiyorum    I want dessert   (noun)
     *     tatlı bir çay      a sweet tea      (adjective)
     *
     * English has two different words, so the word bank offers both and the learner
     * has to pick by role rather than by form. That is the whole exercise.
     */
    ...
    private function lessonsData(TurkishLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Dessert', 1,
                pictures: [['tr' => 'Pasta', 'img' => 'cake'], ['tr' => 'Çay', 'img' => 'tea']],
                plain: [['tr' => 'Tatlı'], ['tr' => 'Pasta']],
                phrases: [
                    'a' => [
                        'words' => ['tatlı', 'istiyorum'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['bir', 'pasta', 'lütfen'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Ice Cream', 2,
                pictures: [['tr' => 'Pasta', 'img' => 'cake'], ['tr' => 'Süt', 'img' => 'milk']],
                plain: [['tr' => 'Dondurma'], ['tr' => 'Tatlı']],
                phrases: [
                    'a' => [
                        'words' => ['dondurma', 'istiyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Chocolate', 3,
                pictures: [['tr' => 'Pasta', 'img' => 'cake'], ['tr' => 'Kahve', 'img' => 'coffee']],
                plain: [['tr' => 'Çikolata'], ['tr' => 'Dondurma']],
                phrases: [
                    'a' => [
                        'words' => ['çikolata', 'istiyorum'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['çikolatalı', 'pasta'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['çikolata', 'çok', 'tatlı'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Too Sweet', 4,
                pictures: [['tr' => 'Şeker', 'img' => 'sugar'], ['tr' => 'Çay', 'img' => 'tea']],
                plain: [['tr' => 'Tatlı'], ['tr' => 'Şeker']],
                phrases: [
                    'a' => [
                        'words' => ['bu', 'çok', 'tatlı'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Ordering Dessert', 5,
                pictures: [['tr' => 'Pasta', 'img' => 'cake'], ['tr' => 'Kahve', 'img' => 'coffee']],
                plain: [['tr' => 'Dondurma'], ['tr' => 'Çikolata']],
                phrases: [
                    'a' => [
                        'words' => ['bir', 'tatlı', 've', 'bir', 'kahve'], 'blank' => 3,
                        'means' => [
