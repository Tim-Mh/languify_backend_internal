...
class ArUnitConversation08Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'هاتف' => 'phone', 'قهوة' => 'coffee', 'شاي' => 'tea', 'ماء' => 'water',
        'حليب' => 'milk', 'خبز' => 'bread', 'جبن' => 'cheese', 'كعكة' => 'cake',
    ];

    /**
     * Arabic Conversation Unit 8.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Hello & Calling', 1,
                pictures: [['ar' => 'هاتف', 'img' => 'phone'], ['ar' => 'قهوة', 'img' => 'coffee']],
                plain: [['ar' => 'مرحبا'], ['ar' => 'أتصل']],
                phrases: [
                    'a' => [
                        'words' => ['مرحبا', 'أتصل'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: I Have Time', 2,
                ...
                plain: [['ar' => 'عندي'], ['ar' => 'وقت']],
                phrases: [
                    'a' => [
                        'words' => ['عندي', 'وقت'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Leaving a Message', 3,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'يوجد'], ['ar' => 'رسالة']],
                phrases: [
                    'a' => [
                        'words' => ['يوجد', 'رسالة'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Is Everything Alright?', 4,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'كل شيء'], ['ar' => 'جيد']],
                phrases: [
                    'a' => [
                        'words' => ['كل شيء', 'جيد'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['الآن', 'هو', 'في المدرسة'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Ending the Call', 5,
                ...
                phrases: [
                    'a' => [
                        'words' => ['الآن', 'هو', 'ليس', 'مشغول'], 'blank' => 3,
                        'means' => [
