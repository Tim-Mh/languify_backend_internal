                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'süte ihtiyacım var', 'correct' => ['süte', 'ihtiyacım', 'var'], 'extra' => []],
                        'ru' => ['sentence' => 'мне нужно молоко', 'correct' => ['мне нужно', 'молоко'], 'extra' => []],
                        'ar' => ['sentence' => 'أحتاج حليب', 'correct' => ['أحتاج', 'حليب'], 'extra' => []],
                        'az' => ['sentence' => 'lazımdır süd', 'correct' => ['lazımdır', 'süd'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'listemle al', 'correct' => ['listemle', 'al'], 'extra' => []],
                        'ru' => ['sentence' => 'купи с мой список', 'correct' => ['купи', 'с', 'мой', 'список'], 'extra' => []],
                        'ar' => ['sentence' => 'اشتر مع قائمة', 'correct' => ['اشتر', 'مع', 'قائمة'], 'extra' => []],
                        'az' => ['sentence' => 'al ilə mənim siyahı', 'correct' => ['al', 'ilə', 'mənim', 'siyahı'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'almak için listeme ihtiyacım var', 'correct' => ['almak', 'için', 'listeme', 'ihtiyacım', 'var'], 'extra' => []],
                        'ru' => ['sentence' => 'мне нужно мой список в купи', 'correct' => ['мне нужно', 'мой', 'список', 'в', 'купи'], 'extra' => []],
                        'ar' => ['sentence' => 'أحتاج قائمة إلى اشتر', 'correct' => ['أحتاج', 'قائمة', 'إلى', 'اشتر'], 'extra' => []],
                        'az' => ['sentence' => 'lazımdır mənim siyahı al', 'correct' => ['lazımdır', 'mənim', 'siyahı', 'al'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'bir kilo pirinç koymak', 'correct' => ['bir', 'kilo', 'pirinç', 'koymak'], 'extra' => []],
                        'ru' => ['sentence' => 'положить кило рис', 'correct' => ['положить', 'кило', 'рис'], 'extra' => []],
                        'ar' => ['sentence' => 'وضع كيلو أرز', 'correct' => ['وضع', 'كيلو', 'أرز'], 'extra' => []],
                        'az' => ['sentence' => 'qoymaq bir kilo düyü', 'correct' => ['qoymaq', 'bir', 'kilo', 'düyü'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'araba dolu', 'correct' => ['araba', 'dolu'], 'extra' => []],
                        'ru' => ['sentence' => 'тележка полный', 'correct' => ['тележка', 'полный'], 'extra' => []],
                        'ar' => ['sentence' => 'عربة ممتلئ', 'correct' => ['عربة', 'ممتلئ'], 'extra' => []],
                        'az' => ['sentence' => 'araba dolu', 'correct' => ['araba', 'dolu'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'pirinci arabaya koymak', 'correct' => ['pirinci', 'arabaya', 'koymak'], 'extra' => []],
                        'ru' => ['sentence' => 'положить рис в тележка', 'correct' => ['положить', 'рис', 'в', 'тележка'], 'extra' => []],
                        'ar' => ['sentence' => 'وضع أرز في عربة', 'correct' => ['وضع', 'أرز', 'في', 'عربة'], 'extra' => []],
                        'az' => ['sentence' => 'qoymaq düyü içində araba', 'correct' => ['qoymaq', 'düyü', 'içində', 'araba'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'biraz taze ekmek', 'correct' => ['biraz', 'taze', 'ekmek'], 'extra' => []],
                        'ru' => ['sentence' => 'немного свежий хлеб', 'correct' => ['немного', 'свежий', 'хлеб'], 'extra' => []],
                        'ar' => ['sentence' => 'بعض طازج خبز', 'correct' => ['بعض', 'طازج', 'خبز'], 'extra' => []],
                        'az' => ['sentence' => 'bir az təzə çörək', 'correct' => ['bir az', 'təzə', 'çörək'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'fırından biraz şeker', 'correct' => ['fırından', 'biraz', 'şeker'], 'extra' => []],
                        'ru' => ['sentence' => 'немного сахар из пекарня', 'correct' => ['немного', 'сахар', 'из', 'пекарня'], 'extra' => []],
                        'ar' => ['sentence' => 'بعض سكر من مخبز', 'correct' => ['بعض', 'سكر', 'من', 'مخبز'], 'extra' => []],
                        'az' => ['sentence' => 'bir az şəkər dan çörəkxana', 'correct' => ['bir az', 'şəkər', 'dan', 'çörəkxana'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'fırından taze ekmek', 'correct' => ['fırından', 'taze', 'ekmek'], 'extra' => []],
                        'ru' => ['sentence' => 'свежий хлеб из пекарня', 'correct' => ['свежий', 'хлеб', 'из', 'пекарня'], 'extra' => []],
                        'ar' => ['sentence' => 'طازج خبز من مخبز', 'correct' => ['طازج', 'خبز', 'من', 'مخبز'], 'extra' => []],
                        'az' => ['sentence' => 'təzə çörək dan çörəkxana', 'correct' => ['təzə', 'çörək', 'dan', 'çörəkxana'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'kasada ödemek', 'correct' => ['kasada', 'ödemek'], 'extra' => []],
                        'ru' => ['sentence' => 'платить на касса', 'correct' => ['платить', 'на', 'касса'], 'extra' => []],
                        'ar' => ['sentence' => 'الدفع على صندوق الدفع', 'correct' => ['الدفع', 'على', 'صندوق الدفع'], 'extra' => []],
                        'az' => ['sentence' => 'ödəmək yanında kassa', 'correct' => ['ödəmək', 'yanında', 'kassa'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'elma için fiş', 'correct' => ['elma', 'için', 'fiş'], 'extra' => []],
                        'ru' => ['sentence' => 'чек для яблоко', 'correct' => ['чек', 'для', 'яблоко'], 'extra' => []],
                        'ar' => ['sentence' => 'إيصال لأجل تفاحة', 'correct' => ['إيصال', 'لأجل', 'تفاحة'], 'extra' => []],
                        'az' => ['sentence' => 'qəbz üçün alma', 'correct' => ['qəbz', 'üçün', 'alma'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'elmayı ödemek', 'correct' => ['elmayı', 'ödemek'], 'extra' => []],
                        'ru' => ['sentence' => 'платить для яблоко', 'correct' => ['платить', 'для', 'яблоко'], 'extra' => []],
                        'ar' => ['sentence' => 'الدفع لأجل تفاحة', 'correct' => ['الدفع', 'لأجل', 'تفاحة'], 'extra' => []],
                        'az' => ['sentence' => 'ödəmək üçün alma', 'correct' => ['ödəmək', 'üçün', 'alma'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'sütü eve taşımak', 'correct' => ['sütü', 'eve', 'taşımak'], 'extra' => []],
                        'ru' => ['sentence' => 'нести молоко в дом', 'correct' => ['нести', 'молоко', 'в', 'дом'], 'extra' => []],
                        'ar' => ['sentence' => 'الحمل حليب إلى بيت', 'correct' => ['الحمل', 'حليب', 'إلى', 'بيت'], 'extra' => []],
                        'az' => ['sentence' => 'daşımaq süd ev', 'correct' => ['daşımaq', 'süd', 'ev'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'araba evde', 'correct' => ['araba', 'evde'], 'extra' => []],
                        'ru' => ['sentence' => 'тележка на дом', 'correct' => ['тележка', 'на', 'дом'], 'extra' => []],
                        'ar' => ['sentence' => 'عربة على بيت', 'correct' => ['عربة', 'على', 'بيت'], 'extra' => []],
                        'az' => ['sentence' => 'araba yanında ev', 'correct' => ['araba', 'yanında', 'ev'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'arabayı eve taşımak', 'correct' => ['arabayı', 'eve', 'taşımak'], 'extra' => []],
                        'ru' => ['sentence' => 'нести тележка в дом', 'correct' => ['нести', 'тележка', 'в', 'дом'], 'extra' => []],
                        'ar' => ['sentence' => 'الحمل عربة إلى بيت', 'correct' => ['الحمل', 'عربة', 'إلى', 'بيت'], 'extra' => []],
                        'az' => ['sentence' => 'daşımaq araba ev', 'correct' => ['daşımaq', 'araba', 'ev'], 'extra' => []],
                        ],
                    ],
                ],
            ),
