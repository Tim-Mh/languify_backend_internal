...
class AzUnitBeginner07Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Gəzmək' => 'walk', 'Park' => 'park', 'Yatmaq' => 'sleep', 'Qəhvə' => 'coffee',
        'Danışmaq' => 'speak', 'Oxumaq' => 'book', 'Kitab' => 'book', 'Dost' => 'friend',
    ];

    /**
     * Azerbaijani Beginner Unit 7.
     *
    ...
    private function lessonsData(AzerbaijaniLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Walking', 1,
                pictures: [['az' => 'Gəzmək', 'img' => 'walk'], ['az' => 'Park', 'img' => 'park']],
                plain: [['az' => 'Yavaş'], ['az' => 'Mən']],
                phrases: [
                    'a' => [
                        'words' => ['gəzmək', 'yavaş'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['mən', 'gəzirəm', 'yavaş'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['gəzirəm', 'yavaş', 'park'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Sleeping', 2,
                pictures: [['az' => 'Yatmaq', 'img' => 'sleep'], ['az' => 'Qəhvə', 'img' => 'coffee']],
                plain: [['az' => 'Yaxşıyam'], ['az' => 'Mən']],
                phrases: [
                    'a' => [
                        'words' => ['yatmaq', 'yaxşıyam'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['mən', 'yatıram', 'yaxşıyam'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['yatıram', 'yaxşıyam', 'və', 'mən', 'gəzirəm', 'yavaş'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Speaking', 3,
                pictures: [['az' => 'Danışmaq', 'img' => 'speak'], ['az' => 'Qəhvə', 'img' => 'coffee']],
                plain: [['az' => 'Yavaş'], ['az' => 'Danışıram']],
                phrases: [
                    'a' => [
                        'words' => ['danışmaq', 'yavaş'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['danışıram', 'bir', 'çoxlu'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['danışıram', 'yavaş', 'və', 'mən', 'oxuyuram', 'bir', 'çoxlu'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Reading', 4,
                pictures: [['az' => 'Oxumaq', 'img' => 'book'], ['az' => 'Kitab', 'img' => 'book']],
                plain: [['az' => 'Bir'], ['az' => 'Mən']],
                phrases: [
                    'a' => [
                        'words' => ['oxumaq', 'bir', 'kitab'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['mən', 'oxuyuram', 'bir', 'kitab'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['oxuyuram', 'yaxşıyam', 'və', 'mən', 'yatıram', 'yaxşıyam'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: My Day', 5,
                pictures: [['az' => 'Dost', 'img' => 'friend'], ['az' => 'Kitab', 'img' => 'book']],
                plain: [['az' => 'Gəzirəm'], ['az' => 'Bir']],
                phrases: [
                    'a' => [
                        'words' => ['gəzirəm', 'bir', 'çoxlu'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['mən', 'danışıram', 'ilə', 'mənim', 'dost'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['gəzirəm', 'məktəbə', 'və', 'mən', 'oxuyuram', 'bir', 'kitab'], 'blank' => 4,
                        'means' => [
