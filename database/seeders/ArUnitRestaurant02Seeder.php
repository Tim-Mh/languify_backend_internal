...
class ArUnitRestaurant02Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'قهوة' => 'coffee', 'شاي' => 'tea', 'حساء' => 'soup', 'لحم' => 'meat',
        'نقود' => 'money', 'سمك' => 'fish', 'قائمة الطعام' => 'menu', 'ماء' => 'water',
    ];

    /**
     * Arabic Restaurant Unit 2.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: What Is the Price', 1,
                ...
                plain: [['ar' => 'ماذا'], ['ar' => 'سعر']],
                phrases: [
                    'a' => [
                        'words' => ['ماذا', 'سعر'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Cheap & Expensive', 2,
                ...
                plain: [['ar' => 'السمك'], ['ar' => 'غالي']],
                phrases: [
                    'a' => [
                        'words' => ['السمك', 'غالي'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: How Many Lira', 3,
                pictures: [['ar' => 'نقود', 'img' => 'money'], ['ar' => 'قهوة', 'img' => 'coffee']],
                plain: [['ar' => 'كم'], ['ar' => 'ريال']],
                phrases: [
                    'a' => [
                        'words' => ['كم', 'ريال'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Reading the Menu', 4,
                pictures: [['ar' => 'سمك', 'img' => 'fish'], ['ar' => 'قائمة الطعام', 'img' => 'menu']],
                plain: [['ar' => 'يوجد'], ['ar' => 'في']],
                phrases: [
                    'a' => [
                        'words' => ['يوجد', 'سمك', 'في', 'قائمة الطعام'], 'blank' => 3,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['لا يوجد', 'لحم', 'في', 'قائمة الطعام'], 'blank' => 3,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Asking About Everything', 5,
                ...
                phrases: [
                    'a' => [
                        'words' => ['كم', 'ريال', 'هذا', 'حساء'], 'blank' => 1,
                        'means' => [
