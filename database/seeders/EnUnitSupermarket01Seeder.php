                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'market için listem', 'correct' => ['market', 'için', 'listem'], 'extra' => []],
                        'ru' => ['sentence' => 'мой список для супермаркет', 'correct' => ['мой', 'список', 'для', 'супермаркет'], 'extra' => []],
                        'ar' => ['sentence' => 'قائمة لأجل سوبرماركت', 'correct' => ['قائمة', 'لأجل', 'سوبرماركت'], 'extra' => []],
                        'az' => ['sentence' => 'mənim siyahı üçün supermarket', 'correct' => ['mənim', 'siyahı', 'üçün', 'supermarket'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'bir araba aramak', 'correct' => ['bir', 'araba', 'aramak'], 'extra' => []],
                        'ru' => ['sentence' => 'искать тележка', 'correct' => ['искать', 'тележка'], 'extra' => []],
                        'ar' => ['sentence' => 'البحث عربة', 'correct' => ['البحث', 'عربة'], 'extra' => []],
                        'az' => ['sentence' => 'axtarmaq bir araba', 'correct' => ['axtarmaq', 'bir', 'araba'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'bir araba ve bir liste', 'correct' => ['bir', 'araba', 've', 'bir', 'liste'], 'extra' => []],
                        'ru' => ['sentence' => 'тележка и список', 'correct' => ['тележка', 'и', 'список'], 'extra' => []],
                        'ar' => ['sentence' => 'عربة و قائمة', 'correct' => ['عربة', 'و', 'قائمة'], 'extra' => []],
                        'az' => ['sentence' => 'bir araba və bir siyahı', 'correct' => ['bir', 'araba', 'və', 'bir', 'siyahı'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'reyon nerede', 'correct' => ['reyon', 'nerede'], 'extra' => []],
                        'ru' => ['sentence' => 'где отдел', 'correct' => ['где', 'отдел'], 'extra' => []],
                        'ar' => ['sentence' => 'أين قسم', 'correct' => ['أين', 'قسم'], 'extra' => []],
                        'az' => ['sentence' => 'harada şöbə', 'correct' => ['harada', 'şöbə'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'bir sepet bulmak', 'correct' => ['bir', 'sepet', 'bulmak'], 'extra' => []],
                        'ru' => ['sentence' => 'найти корзина', 'correct' => ['найти', 'корзина'], 'extra' => []],
                        'ar' => ['sentence' => 'العثور سلة', 'correct' => ['العثور', 'سلة'], 'extra' => []],
                        'az' => ['sentence' => 'tapmaq bir səbət', 'correct' => ['tapmaq', 'bir', 'səbət'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'reyonu bulmak', 'correct' => ['reyonu', 'bulmak'], 'extra' => []],
                        'ru' => ['sentence' => 'найти отдел', 'correct' => ['найти', 'отдел'], 'extra' => []],
                        'ar' => ['sentence' => 'العثور قسم', 'correct' => ['العثور', 'قسم'], 'extra' => []],
                        'az' => ['sentence' => 'tapmaq şöbə', 'correct' => ['tapmaq', 'şöbə'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'burada al', 'correct' => ['burada', 'al'], 'extra' => []],
                        'ru' => ['sentence' => 'купи здесь', 'correct' => ['купи', 'здесь'], 'extra' => []],
                        'ar' => ['sentence' => 'اشتر هنا', 'correct' => ['اشتر', 'هنا'], 'extra' => []],
                        'az' => ['sentence' => 'al burada', 'correct' => ['al', 'burada'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'kasa burada', 'correct' => ['kasa', 'burada'], 'extra' => []],
                        'ru' => ['sentence' => 'касса здесь', 'correct' => ['касса', 'здесь'], 'extra' => []],
                        'ar' => ['sentence' => 'صندوق الدفع هنا', 'correct' => ['صندوق الدفع', 'هنا'], 'extra' => []],
                        'az' => ['sentence' => 'kassa burada', 'correct' => ['kassa', 'burada'], 'extra' => []],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'arabayla al', 'correct' => ['arabayla', 'al'], 'extra' => []],
                        'ru' => ['sentence' => 'купи с тележка', 'correct' => ['купи', 'с', 'тележка'], 'extra' => []],
                        'ar' => ['sentence' => 'اشتر مع عربة', 'correct' => ['اشتر', 'مع', 'عربة'], 'extra' => []],
                        'az' => ['sentence' => 'al ilə bir araba', 'correct' => ['al', 'ilə', 'bir', 'araba'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'ekmeğe ihtiyacım var', 'correct' => ['ekmeğe', 'ihtiyacım', 'var'], 'extra' => []],
                        'ru' => ['sentence' => 'мне нужно хлеб', 'correct' => ['мне нужно', 'хлеб'], 'extra' => []],
                        'ar' => ['sentence' => 'أحتاج خبز', 'correct' => ['أحتاج', 'خبز'], 'extra' => []],
                        'az' => ['sentence' => 'lazımdır çörək', 'correct' => ['lazımdır', 'çörək'], 'extra' => []],
                        ],
                    ],
                    'b' => [
                    ...
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'listeme ihtiyacım var', 'correct' => ['listeme', 'ihtiyacım', 'var'], 'extra' => []],
                        'ru' => ['sentence' => 'мне нужно мой список', 'correct' => ['мне нужно', 'мой', 'список'], 'extra' => []],
                        'ar' => ['sentence' => 'أحتاج قائمة', 'correct' => ['أحتاج', 'قائمة'], 'extra' => []],
                        'az' => ['sentence' => 'lazımdır mənim siyahı', 'correct' => ['lazımdır', 'mənim', 'siyahı'], 'extra' => []],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    ...
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'sepet ağır', 'correct' => ['sepet', 'ağır'], 'extra' => []],
                        'ru' => ['sentence' => 'корзина тяжёлый', 'correct' => ['корзина', 'тяжёлый'], 'extra' => []],
                        'ar' => ['sentence' => 'سلة ثقيل', 'correct' => ['سلة', 'ثقيل'], 'extra' => []],
                        'az' => ['sentence' => 'səbət ağır', 'correct' => ['səbət', 'ağır'], 'extra' => []],
                        ],
                    ],
                    'c' => [
