...
class RuUnitSupermarket10Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Супермаркет' => 'shop', 'Яблоко' => 'apple', 'Молоко' => 'milk', 'Хлеб' => 'bread',
        'Кофе' => 'coffee', 'Касса' => 'checkout', 'Карта' => 'card', 'Чай' => 'tea',
    ];

    /**
     * Russian Supermarket Unit 10.
     *
    ...
    private function lessonsData(RussianLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Going to the Shop', 1,
                pictures: [['ru' => 'Супермаркет', 'img' => 'shop'], ['ru' => 'Яблоко', 'img' => 'apple']],
                plain: [['ru' => 'Иду'], ['ru' => 'Есть']],
                phrases: [
                    'a' => [
                    ...
                    'b' => [
                        'words' => ['есть', 'яблоко', 'в', 'списке'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['я', 'покупаю', 'корзина'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Finding Things', 2,
                ...
                phrases: [
                    ...
                    'c' => [
                        'words' => ['я', 'покупаю', 'свежий', 'хлеб'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Weighing', 3,
                ...
                plain: [['ru' => 'Два'], ['ru' => 'Кило']],
                phrases: [
                    'a' => [
                        'words' => ['два', 'кило', 'яблоки'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Checking the Price', 4,
                ...
                phrases: [
                    ...
                    'b' => [
                        'words' => ['яблоко', 'со скидкой'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Paying and Leaving', 5,
                pictures: [['ru' => 'Касса', 'img' => 'checkout'], ['ru' => 'Карта', 'img' => 'card']],
                plain: [['ru' => 'Где'], ['ru' => 'Плачу']],
                phrases: [
                    'a' => [
