...
class ArUnitConversation10Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'سيارة' => 'car', 'كبير' => 'big', 'بيت' => 'house', 'كتاب' => 'book',
        'قهوة' => 'coffee', 'شاي' => 'tea', 'ماء' => 'water', 'حليب' => 'milk',
    ];

    /**
     * Arabic Conversation Unit 10.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Bigger & Smaller', 1,
                pictures: [['ar' => 'سيارة', 'img' => 'car'], ['ar' => 'كبير', 'img' => 'big']],
                plain: [['ar' => 'البيت'], ['ar' => 'أكبر']],
                phrases: [
                    'a' => [
                        'words' => ['البيت', 'أكبر'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: The Best One', 2,
                pictures: [['ar' => 'بيت', 'img' => 'house'], ['ar' => 'كتاب', 'img' => 'book']],
                plain: [['ar' => 'هذا'], ['ar' => 'الأفضل']],
                phrases: [
                    'a' => [
                        'words' => ['هذا', 'الأفضل'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: New & Old', 3,
                pictures: [['ar' => 'سيارة', 'img' => 'car'], ['ar' => 'كتاب', 'img' => 'book']],
                plain: [['ar' => 'هذا'], ['ar' => 'جديد']],
                phrases: [
                    'a' => [
                        'words' => ['هذا', 'سيارة', 'جديد'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: I Prefer', 4,
                ...
                plain: [['ar' => 'أفضل'], ['ar' => 'أحسن']],
                phrases: [
                    'a' => [
                        'words' => ['أفضل', 'قهوة'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Putting It Together', 5,
                pictures: [['ar' => 'شاي', 'img' => 'tea'], ['ar' => 'سيارة', 'img' => 'car']],
                plain: [['ar' => 'برأيي'], ['ar' => 'أحسن']],
                phrases: [
                    'a' => [
                        'words' => ['برأيي', 'شاي', 'أحسن'], 'blank' => 0,
                        'means' => [
