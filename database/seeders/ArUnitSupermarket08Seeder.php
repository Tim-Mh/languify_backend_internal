...
class ArUnitSupermarket08Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'صندوق الدفع' => 'checkout', 'قهوة' => 'coffee', 'بطاقة' => 'card', 'شاي' => 'tea',
        'ماء' => 'water', 'حليب' => 'milk', 'خبز' => 'bread', 'جبن' => 'cheese',
    ];

    /**
     * Arabic Supermarket Unit 8.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: The Checkout', 1,
                pictures: [['ar' => 'صندوق الدفع', 'img' => 'checkout'], ['ar' => 'قهوة', 'img' => 'coffee']],
                plain: [['ar' => 'أين'], ['ar' => 'هنا']],
                phrases: [
                    'a' => [
            ...
            $builder->lesson('Lesson 2: Paying', 2,
                pictures: [['ar' => 'بطاقة', 'img' => 'card'], ['ar' => 'قهوة', 'img' => 'coffee']],
                plain: [['ar' => 'أدفع'], ['ar' => 'مع']],
                phrases: [
                    'a' => [
                    ...
                    'c' => [
                        'words' => ['المجموع', 'عشرون', 'ريال'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: A Bag', 3,
                ...
                plain: [['ar' => 'أريد'], ['ar' => 'كيس']],
                phrases: [
                    'a' => [
                        'words' => ['أريد', 'كيس'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: The Receipt', 4,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'المجموع'], ['ar' => 'صحيح']],
                phrases: [
                    'a' => [
                        'words' => ['المجموع', 'صحيح'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Leaving the Shop', 5,
                ...
                phrases: [
                    ...
                    'b' => [
                        'words' => ['مع', 'بطاقة', 'من فضلك'], 'blank' => 2,
                        'means' => [
