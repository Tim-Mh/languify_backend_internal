...
class RuUnitRestaurant06Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Мясо' => 'meat', 'Рыба' => 'fish', 'Сыр' => 'cheese', 'Молоко' => 'milk',
        'Кофе' => 'coffee', 'Чай' => 'tea', 'Вода' => 'water', 'Хлеб' => 'bread',
    ];

    /**
     * Russian Restaurant Unit 6.
     *
    ...
    private function lessonsData(RussianLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: I Cannot Eat', 1,
                pictures: [['ru' => 'Мясо', 'img' => 'meat'], ['ru' => 'Рыба', 'img' => 'fish']],
                plain: [['ru' => 'Не'], ['ru' => 'Могу']],
                phrases: [
                    'a' => [
                        'words' => ['не', 'могу', 'кушать', 'мясо'], 'blank' => 2,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['не', 'могу', 'кушать', 'рыба'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Vegetarian', 2,
                pictures: [['ru' => 'Мясо', 'img' => 'meat'], ['ru' => 'Сыр', 'img' => 'cheese']],
                plain: [['ru' => 'Вегетарианец'], ['ru' => 'Не']],
                phrases: [
                    'a' => [
                        'words' => ['я', 'вегетарианец'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Milk & Cheese', 3,
                pictures: [['ru' => 'Молоко', 'img' => 'milk'], ['ru' => 'Сыр', 'img' => 'cheese']],
                plain: [['ru' => 'Меня'], ['ru' => 'Аллергия']],
                phrases: [
                    'a' => [
                        'words' => ['у', 'меня', 'молоко', 'аллергия'], 'blank' => 3,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['не', 'могу', 'кушать', 'сыр'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['без', 'молока', 'пожалуйста'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Asking the Waiter', 4,
                pictures: [['ru' => 'Мясо', 'img' => 'meat'], ['ru' => 'Молоко', 'img' => 'milk']],
                plain: [['ru' => 'Ли'], ['ru' => 'Этом']],
                phrases: [
                    'a' => [
                        'words' => ['ли', 'мясо', 'в', 'этом'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['нету', 'молоко', 'в', 'этом'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Ordering Safely', 5,
                ...
                phrases: [
                    'a' => [
                        'words' => ['я', 'вегетарианец', 'и', 'не', 'могу', 'кушать', 'мясо'], 'blank' => 1,
                        'means' => [
