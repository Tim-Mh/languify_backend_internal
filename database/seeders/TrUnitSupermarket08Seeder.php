...
class TrUnitSupermarket08Seeder extends Seeder
{
    ...
    /**
     * Turkish Supermarket Unit 8 - paying and leaving.
     *
     * THE RULE THIS UNIT TEACHES: THE SAME PAYING WORDS WORK ANYWHERE.
     *
     * `kart ile`, `nakit ile`, `ödüyorum` were learned in Restaurant 3. Nothing
     * about them changes at a supermarket till, which is the point: Turkish does
     * not have a separate register for shops. Re-meeting them in a new place is
     * what turns them from a restaurant phrase into vocabulary.
     *
     * The one new shape is `poşet ister misiniz`, "would you like a bag", where
     * `misiniz` is the polite question ending. It is a whole tile, because pulling
     * `mi` off it and conjugating the rest is several lessons beyond this one.
     */
    ...
    private function lessonsData(TurkishLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: The Checkout', 1,
                pictures: [['tr' => 'Kasa', 'img' => 'checkout'], ['tr' => 'Sepet', 'img' => 'basket']],
                plain: [['tr' => 'Kasa'], ['tr' => 'Poşet']],
                phrases: [
                    'a' => [
                    ...
                    'c' => [
                        'words' => ['bir', 'poşet', 'lütfen'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Paying', 2,
                ...
                phrases: [
                    ...
                    'b' => [
                        'words' => ['nakit', 'ile', 'ödüyorum'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['toplam', 'yirmi', 'lira'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: A Bag', 3,
                pictures: [['tr' => 'Sepet', 'img' => 'basket'], ['tr' => 'Süt', 'img' => 'milk']],
                plain: [['tr' => 'Poşet'], ['tr' => 'Sepet']],
                phrases: [
                    'a' => [
                        'words' => ['poşet', 'istiyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: The Receipt', 4,
                pictures: [['tr' => 'Kasa', 'img' => 'checkout'], ['tr' => 'Elma', 'img' => 'apple']],
                plain: [['tr' => 'Toplam'], ['tr' => 'Kasa']],
                phrases: [
                    'a' => [
                        'words' => ['toplam', 'doğru'], 'blank' => 1,
                        'means' => [
