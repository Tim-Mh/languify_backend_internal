...
class TrUnitConversation08Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Telefon' => 'phone', 'Arkadaş' => 'friend', 'Ev' => 'house',
        'Kitap' => 'book', 'Okul' => 'school',
    ];

    /**
     * Turkish Conversation Unit 8 — on the phone.
     *
     * THE RULE THIS UNIT TEACHES: `var` AND `yok` CARRY A WHOLE SENTENCE.
     *
     * English needs a verb to say something exists. Turkish has two words that
     * do it alone, and they sit at the end like any other predicate:
     *
     *     zamanım var    my-time exists      -> I have time
     *     zamanım yok    my-time not-exists  -> I do not have time
     *
     * There is no "have" here at all. Possession is the -ım on `zaman`, and
     * `var`/`yok` only say whether the thing is there. That is why the tiles
     * are `zamanım` and `var`, never a tile meaning "I have".
     *
     * `alo` is the phone-only hello. Turkish does not reuse `merhaba` when
     * answering a call, so this unit teaches the one that is actually correct
     * in the situation rather than the one already learned in Unit 1.
     */
    ...
    private function lessonsData(TurkishLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Hello & Calling', 1,
                pictures: [['tr' => 'Telefon', 'img' => 'phone'], ['tr' => 'Arkadaş', 'img' => 'friend']],
                plain: [['tr' => 'Alo'], ['tr' => 'Arıyorum']],
                phrases: [
                    'a' => [
                        'words' => ['alo', 'ben', 'arıyorum'], 'blank' => 2,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['arkadaşımı', 'arıyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: I Have Time', 2,
                ...
                phrases: [
                    'a' => [
                        // Possession is the -ım; `var` only says it exists.
                        'words' => ['zamanım', 'var'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Leaving a Message', 3,
                pictures: [['tr' => 'Telefon', 'img' => 'phone'], ['tr' => 'Kitap', 'img' => 'book']],
                plain: [['tr' => 'Mesaj'], ['tr' => 'Numara']],
                phrases: [
                    'a' => [
                        'words' => ['bir', 'mesaj', 'var'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Is Everything Alright?', 4,
                ...
                plain: [['tr' => 'İyi'], ['tr' => 'Şimdi']],
                phrases: [
                    'a' => [
                        'words' => ['her', 'şey', 'iyi'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Ending the Call', 5,
                pictures: [['tr' => 'Telefon', 'img' => 'phone'], ['tr' => 'Arkadaş', 'img' => 'friend']],
                plain: [['tr' => 'Ararım'], ['tr' => 'Meşgul']],
                phrases: [
                    'a' => [
                        'words' => ['şimdi', 'meşgul', 'değil'], 'blank' => 2,
                        'means' => [
