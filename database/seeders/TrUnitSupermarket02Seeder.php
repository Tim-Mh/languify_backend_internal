...
class TrUnitSupermarket02Seeder extends Seeder
{
    ...
    /**
     * Turkish Supermarket Unit 2 - fruit.
     *
     * THE RULE THIS UNIT TEACHES: THE PLURAL IS -lar/-ler, AND A NUMBER CANCELS IT.
     *
     * Turkish does have a plural, and it harmonises like everything else: `elmalar`
     * apples, `üzümler` grapes. But the moment a number appears the plural drops:
     *
     *     elmalar      apples
     *     beş elma     five apples      (never `beş elmalar`)
     *
     * Restaurant 4 met this with `iki kişi`. Here it is stated outright, with both
     * forms side by side in the same lesson, because it is the rule English speakers
     * break most often.
     */
    ...
    private function lessonsData(TurkishLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Apple & Banana', 1,
                pictures: [['tr' => 'Elma', 'img' => 'apple'], ['tr' => 'Muz', 'img' => 'banana']],
                plain: [['tr' => 'Meyve'], ['tr' => 'Elma']],
                phrases: [
                    'a' => [
                        'words' => ['bir', 'elma', 'istiyorum'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Apples, Plural', 2,
                pictures: [['tr' => 'Elma', 'img' => 'apple'], ['tr' => 'Portakal', 'img' => 'orange']],
                plain: [['tr' => 'Elmalar'], ['tr' => 'Meyve']],
                phrases: [
                    'a' => [
                    ...
                    'c' => [
                        'words' => ['portakal', 'istiyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Grapes', 3,
                pictures: [['tr' => 'Üzüm', 'img' => 'grapes'], ['tr' => 'Elma', 'img' => 'apple']],
                plain: [['tr' => 'Üzüm'], ['tr' => 'Taze']],
                phrases: [
                    'a' => [
                        'words' => ['üzüm', 'istiyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Buying Fruit', 4,
                pictures: [['tr' => 'Muz', 'img' => 'banana'], ['tr' => 'Üzüm', 'img' => 'grapes']],
                plain: [['tr' => 'Alıyorum'], ['tr' => 'Meyve']],
                phrases: [
                    'a' => [
                        'words' => ['meyve', 'alıyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: The Fruit Aisle', 5,
                pictures: [['tr' => 'Portakal', 'img' => 'orange'], ['tr' => 'Elma', 'img' => 'apple']],
                plain: [['tr' => 'Meyve'], ['tr' => 'Reyon']],
                phrases: [
                    'a' => [
                        'words' => ['meyve', 'reyonda'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['iki', 'portakal', 'lütfen'], 'blank' => 1,
                        'means' => [
