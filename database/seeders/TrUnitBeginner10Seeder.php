            ...
            $builder->lesson('Lesson 1: Happy & Sad', 1,
                ...
                phrases: [
                    'a' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'My friend is happy', 'correct' => ['my', 'friend', 'happy'], 'extra' => ['sad']],
                            'fr' => ['sentence' => 'Mon ami est heureux', 'correct' => ['mon', 'ami', 'heureux'], 'extra' => ['triste']],
                            'es' => ['sentence' => 'Mi amigo está feliz', 'correct' => ['mi', 'amigo', 'feliz'], 'extra' => ['triste']],
                            'de' => ['sentence' => 'Mein Freund ist glücklich', 'correct' => ['mein', 'Freund', 'glücklich'], 'extra' => ['traurig']],
                    ...
                    'b' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'My mother is sad', 'correct' => ['my', 'mother', 'sad'], 'extra' => ['happy']],
                            'fr' => ['sentence' => 'Ma mère est triste', 'correct' => ['ma', 'mère', 'triste'], 'extra' => ['heureux']],
                            'es' => ['sentence' => 'Mi madre está triste', 'correct' => ['mi', 'madre', 'triste'], 'extra' => ['feliz']],
                            'de' => ['sentence' => 'Meine Mutter ist traurig', 'correct' => ['meine', 'Mutter', 'traurig'], 'extra' => ['glücklich']],
                    ...
                    'c' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'I am happy today', 'correct' => ['I', 'today', 'I am happy'], 'extra' => ['sad']],
                            'fr' => ['sentence' => "Je suis heureux aujourd'hui", 'correct' => ['je', "aujourd'hui", 'je suis heureux'], 'extra' => ['triste']],
                            'es' => ['sentence' => 'Hoy estoy feliz', 'correct' => ['yo', 'hoy', 'estoy feliz'], 'extra' => ['triste']],
                            'de' => ['sentence' => 'Ich bin heute glücklich', 'correct' => ['ich', 'heute', 'ich bin glücklich'], 'extra' => ['traurig']],
            ...
            $builder->lesson('Lesson 2: Tired & Sick', 2,
                ...
                phrases: [
                    'a' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'I am tired', 'correct' => ['I', 'I am tired'], 'extra' => ['sick']],
                            'fr' => ['sentence' => 'Je suis fatigué', 'correct' => ['je', 'je suis fatigué'], 'extra' => ['malade']],
                            'es' => ['sentence' => 'Estoy cansado', 'correct' => ['yo', 'estoy cansado'], 'extra' => ['enfermo']],
                            'de' => ['sentence' => 'Ich bin müde', 'correct' => ['ich', 'ich bin müde'], 'extra' => ['krank']],
                    ...
                    'b' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'My father is sick', 'correct' => ['my', 'father', 'sick'], 'extra' => ['tired']],
                            'fr' => ['sentence' => 'Mon père est malade', 'correct' => ['mon', 'père', 'malade'], 'extra' => ['fatigué']],
                            'es' => ['sentence' => 'Mi padre está enfermo', 'correct' => ['mi', 'padre', 'enfermo'], 'extra' => ['cansado']],
                            'de' => ['sentence' => 'Mein Vater ist krank', 'correct' => ['mein', 'Vater', 'krank'], 'extra' => ['müde']],
                    ...
                    'c' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'I am tired and to go home', 'correct' => ['I', 'I am tired', 'and', 'to go', 'to the house'], 'extra' => ['sick']],
                            'fr' => ['sentence' => 'Je suis fatigué et aller à la maison', 'correct' => ['je', 'je suis fatigué', 'et', 'aller', 'à la maison'], 'extra' => ['malade']],
                            'es' => ['sentence' => 'Estoy cansado y ir a casa', 'correct' => ['yo', 'estoy cansado', 'y', 'ir', 'a casa'], 'extra' => ['enfermo']],
                            'de' => ['sentence' => 'Ich bin müde und nach Hause gehen', 'correct' => ['ich', 'ich bin müde', 'und', 'nach Hause', 'gehen'], 'extra' => ['krank']],
            ...
            $builder->lesson('Lesson 3: Review — Eating', 3,
                ...
                phrases: [
                    ...
                    'c' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'Today to drink the soup and eat bread', 'correct' => ['today', 'to drink', 'the soup', 'and', 'bread', 'to eat'], 'extra' => ['apple']],
            ...
            $builder->lesson('Lesson 4: Review — Going', 4,
                ...
                phrases: [
                    'a' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'I walk to school', 'correct' => ['I', 'I walk', 'to school'], 'extra' => ['park']],
                            'fr' => ['sentence' => "Je marche à l'école", 'correct' => ['je', 'je marche', "à l'école"], 'extra' => ['parc']],
                            'es' => ['sentence' => 'Camino a la escuela', 'correct' => ['yo', 'camino', 'a la escuela'], 'extra' => ['parque']],
                            'de' => ['sentence' => 'Ich gehe zur Schule', 'correct' => ['ich', 'ich gehe', 'zur Schule'], 'extra' => ['Park']],
                    ...
                    'c' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'Today I walk to school and tomorrow to the park', 'correct' => ['today', 'I', 'I walk', 'to school', 'and', 'tomorrow', 'to the park'], 'extra' => ['house']],
                            ...
                            'es' => ['sentence' => 'Hoy camino a la escuela y mañana al parque', 'correct' => ['hoy', 'yo', 'camino', 'a la escuela', 'y', 'mañana', 'al parque'], 'extra' => ['casa']],
                            'de' => ['sentence' => 'Heute gehe ich zur Schule und morgen zum Park', 'correct' => ['heute', 'ich', 'ich gehe', 'zur Schule', 'und', 'morgen', 'zum Park'], 'extra' => ['Haus']],
                ...
                phrases: [
                    'a' => [
                        ...
                        'means' => [
                            ...
                            'es' => ['sentence' => 'Una casa pequeña', 'correct' => ['una', 'casa', 'pequeño'], 'extra' => ['grande']],
                            'de' => ['sentence' => 'Ein kleines Haus', 'correct' => ['ein', 'klein', 'Haus'], 'extra' => ['groß']],
                    ...
                    'c' => [
                        ...
                        'means' => [
                            'en' => ['sentence' => 'I am happy and I read a book', 'correct' => ['I', 'I am happy', 'and', 'I read', 'a', 'book'], 'extra' => ['tired']],
                            'fr' => ['sentence' => 'Je suis heureux et je lis un livre', 'correct' => ['je', 'je suis heureux', 'et', 'je lis', 'un', 'livre'], 'extra' => ['fatigué']],
                            'es' => ['sentence' => 'Estoy feliz y leo un libro', 'correct' => ['yo', 'estoy feliz', 'y', 'leo', 'un', 'libro'], 'extra' => ['cansado']],
                            'de' => ['sentence' => 'Ich bin glücklich und ich lese ein Buch', 'correct' => ['ich', 'ich bin glücklich', 'und', 'ich lese', 'ein', 'Buch'], 'extra' => ['müde']],
