...
class TrUnitSupermarket04Seeder extends Seeder
{
    ...
    /**
     * Turkish Supermarket Unit 4 - the cold shelf and the bread counter.
     *
     * THE RULE THIS UNIT TEACHES: A COMPOUND NOUN TAKES -ı ON THE SECOND WORD.
     *
     * `tereyağı` is `tere` plus `yağ` plus -ı: literally "the oil of tere". Turkish
     * builds compounds by marking the SECOND element, which is the reverse of the
     * English habit of just placing two nouns together.
     *
     * The learner never has to build one here, because the compound is a single
     * tile, but meeting the shape matters: `tereyağı`, `meyve suyu`, `zeytinyağı`
     * all follow it, and once seen the pattern is recognisable everywhere.
     */
    ...
    private function lessonsData(TurkishLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Milk & Yoghurt', 1,
                ...
                plain: [['tr' => 'Yoğurt'], ['tr' => 'Süt']],
                phrases: [
                    'a' => [
                        'words' => ['süt', 'alıyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Butter & Cheese', 2,
                ...
                plain: [['tr' => 'Tereyağı'], ['tr' => 'Peynir']],
                phrases: [
                    'a' => [
                        'words' => ['tereyağı', 'istiyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Eggs', 3,
                ...
                plain: [['tr' => 'Yumurta'], ['tr' => 'Kutu']],
                phrases: [
                    'a' => [
                        'words' => ['yumurta', 'alıyorum'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: The Bakery', 4,
                pictures: [['tr' => 'Ekmek', 'img' => 'bread'], ['tr' => 'Pasta', 'img' => 'cake']],
                plain: [['tr' => 'Ekmek'], ['tr' => 'Pasta']],
                phrases: [
                    'a' => [
                        'words' => ['taze', 'ekmek'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['bir', 'ekmek', 'lütfen'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: The Cold Shelf', 5,
                pictures: [['tr' => 'Süt', 'img' => 'milk'], ['tr' => 'Yumurta', 'img' => 'egg']],
                plain: [['tr' => 'Yoğurt'], ['tr' => 'Tereyağı']],
                phrases: [
                    'a' => [
                        'words' => ['süt', 've', 'yumurta', 'alıyorum'], 'blank' => 2,
                        'means' => [
