...
class ArUnitRestaurant06Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'لحم' => 'meat', 'سمك' => 'fish', 'جبن' => 'cheese', 'حليب' => 'milk',
        'قهوة' => 'coffee', 'شاي' => 'tea', 'ماء' => 'water', 'خبز' => 'bread',
    ];

    /**
     * Arabic Restaurant Unit 6.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: I Cannot Eat', 1,
                pictures: [['ar' => 'لحم', 'img' => 'meat'], ['ar' => 'سمك', 'img' => 'fish']],
                plain: [['ar' => 'لا أستطيع الأكل'], ['ar' => 'عندي']],
                phrases: [
                    'a' => [
                        'words' => ['لا أستطيع الأكل', 'لحم'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['لا أستطيع الأكل', 'سمك'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Vegetarian', 2,
                pictures: [['ar' => 'لحم', 'img' => 'meat'], ['ar' => 'جبن', 'img' => 'cheese']],
                plain: [['ar' => 'أنا'], ['ar' => 'نباتي']],
                phrases: [
                    'a' => [
                        'words' => ['أنا', 'نباتي'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Milk & Cheese', 3,
                pictures: [['ar' => 'حليب', 'img' => 'milk'], ['ar' => 'جبن', 'img' => 'cheese']],
                plain: [['ar' => 'عندي'], ['ar' => 'حساسية']],
                phrases: [
                    'a' => [
                        'words' => ['عندي', 'حليب', 'حساسية'], 'blank' => 2,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['لا أستطيع الأكل', 'جبن'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['بدون حليب', 'من فضلك'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Asking the Waiter', 4,
                pictures: [['ar' => 'لحم', 'img' => 'meat'], ['ar' => 'حليب', 'img' => 'milk']],
                plain: [['ar' => 'هل'], ['ar' => 'في هذا']],
                phrases: [
                    'a' => [
                        'words' => ['هل', 'لحم', 'في هذا'], 'blank' => 2,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['لا يوجد', 'حليب', 'في هذا'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Ordering Safely', 5,
                ...
                phrases: [
                    'a' => [
                        'words' => ['أنا', 'نباتي', 'و', 'لا أستطيع الأكل', 'لحم'], 'blank' => 3,
                        'means' => [
