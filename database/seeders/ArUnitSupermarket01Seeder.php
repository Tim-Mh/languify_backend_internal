...
class ArUnitSupermarket01Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'سلة' => 'basket', 'كبير' => 'big', 'خبز' => 'bread', 'جبن' => 'cheese',
        'حليب' => 'milk', 'قهوة' => 'coffee', 'شاي' => 'tea', 'ماء' => 'water',
    ];

    /**
     * Arabic Supermarket Unit 1.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: The Supermarket', 1,
                pictures: [['ar' => 'سلة', 'img' => 'basket'], ['ar' => 'كبير', 'img' => 'big']],
                ...
                phrases: [
                    ...
                    'c' => [
                        'words' => ['السوبرماركت', 'كبير'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: In the Aisle', 3,
                ...
                phrases: [
                    ...
                    'b' => [
                        'words' => ['الماء', 'في السوبرماركت'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: A Shopping List', 4,
                pictures: [['ar' => 'خبز', 'img' => 'bread'], ['ar' => 'حليب', 'img' => 'milk']],
                plain: [['ar' => 'يوجد'], ['ar' => 'قائمة']],
                phrases: [
                    'a' => [
                        'words' => ['يوجد', 'قائمة'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['يوجد', 'خبز', 'في القائمة'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['لا يوجد', 'حليب', 'في القائمة'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Around the Shop', 5,
                pictures: [['ar' => 'جبن', 'img' => 'cheese'], ['ar' => 'سلة', 'img' => 'basket']],
