...
class RuUnitRestaurant07Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Чай' => 'tea', 'Кофе' => 'coffee', 'Вода' => 'water', 'Молоко' => 'milk',
        'Хлеб' => 'bread', 'Сыр' => 'cheese', 'Торт' => 'cake', 'Сахар' => 'sugar',
    ];

    /**
     * Russian Restaurant Unit 7.
     *
    ...
    private function lessonsData(RussianLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: A Drink', 1,
                pictures: [['ru' => 'Чай', 'img' => 'tea'], ['ru' => 'Кофе', 'img' => 'coffee']],
                plain: [['ru' => 'Хочу'], ['ru' => 'Напиток']],
                phrases: [
                    'a' => [
                        'words' => ['я', 'хочу', 'напиток'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: With & Without Ice', 2,
                ...
                plain: [['ru' => 'Со'], ['ru' => 'Льдом']],
                phrases: [
                    'a' => [
                        'words' => ['вода', 'со', 'льдом'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['без', 'льда', 'пожалуйста'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Sugar or Not', 3,
                pictures: [['ru' => 'Чай', 'img' => 'tea'], ['ru' => 'Кофе', 'img' => 'coffee']],
                plain: [['ru' => 'Сахаром'], ['ru' => 'Без']],
                phrases: [
                    'a' => [
                        'words' => ['чай', 'с', 'сахаром'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Wine & Beer', 4,
                ...
                plain: [['ru' => 'Вино'], ['ru' => 'Пожалуйста']],
                phrases: [
                    'a' => [
                        'words' => ['вино', 'пожалуйста'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: The Whole Round', 5,
                ...
                plain: [['ru' => 'Без'], ['ru' => 'Сахара']],
                phrases: [
                    'a' => [
                        'words' => ['кофе', 'без', 'сахара', 'пожалуйста'], 'blank' => 3,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['напиток', 'холодный'], 'blank' => 1,
                        'means' => [
