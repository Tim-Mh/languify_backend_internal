                ...
                phrases: [
                    ...
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mən kədərli', 'correct' => ['mən', 'kədərli'], 'extra' => ['xoşbəxt', 'ana']],
                            'ar' => ['sentence' => 'أنا حزين', 'correct' => ['أنا', 'حزين'], 'extra' => ['فرح', 'أم']],
                            'ru' => ['sentence' => 'я грустный', 'correct' => ['я', 'грустный'], 'extra' => ['счастливый', 'мама']],
                            ...
                            'tr' => ['sentence' => 'üzgünüm', 'correct' => ['üzgünüm'], 'extra' => ['mutlu', 'anne']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mənim dost xoşbəxt və mənim ana kədərli', 'correct' => ['mənim', 'dost', 'xoşbəxt', 'və', 'mənim', 'ana', 'kədərli'], 'extra' => ['yorğun']],
                            'ar' => ['sentence' => 'صديق فرح و أم حزين', 'correct' => ['صديق', 'فرح', 'و', 'أم', 'حزين'], 'extra' => ['متعب']],
                            'ru' => ['sentence' => 'мой друг счастливый и мой мама грустный', 'correct' => ['мой', 'друг', 'счастливый', 'и', 'мой', 'мама', 'грустный'], 'extra' => ['усталый']],
                            ...
                            'tr' => ['sentence' => 'arkadaşım mutlu ve annem üzgün', 'correct' => ['arkadaşım', 'mutlu', 've', 'annem', 'üzgün'], 'extra' => ['yorgun']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mən yorğun', 'correct' => ['mən', 'yorğun'], 'extra' => ['xəstə', 'ata']],
                            'ar' => ['sentence' => 'أنا متعب', 'correct' => ['أنا', 'متعب'], 'extra' => ['مريض', 'أب']],
                            'ru' => ['sentence' => 'я усталый', 'correct' => ['я', 'усталый'], 'extra' => ['больной', 'папа']],
                            ...
                            'tr' => ['sentence' => 'ben yorgunum', 'correct' => ['ben', 'yorgunum'], 'extra' => ['hasta', 'baba']],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'tr' => ['sentence' => 'babam hasta', 'correct' => ['babam', 'hasta'], 'extra' => ['yorgun']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mənim qardaş yorğun', 'correct' => ['mənim', 'qardaş', 'yorğun'], 'extra' => ['xəstə']],
                            'ar' => ['sentence' => 'أخ متعب', 'correct' => ['أخ', 'متعب'], 'extra' => ['مريض']],
                            'ru' => ['sentence' => 'мой брат усталый', 'correct' => ['мой', 'брат', 'усталый'], 'extra' => ['больной']],
                            ...
                            'tr' => ['sentence' => 'erkek kardeşim yorgun', 'correct' => ['erkek', 'kardeşim', 'yorgun'], 'extra' => ['hasta']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    ...
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'müəllim şad', 'correct' => ['müəllim', 'şad'], 'extra' => ['sakit']],
                            'ar' => ['sentence' => 'معلم سعيد', 'correct' => ['معلم', 'سعيد'], 'extra' => ['هادئ']],
                            'ru' => ['sentence' => 'учитель рада', 'correct' => ['учитель', 'рада'], 'extra' => ['спокойный']],
                            ...
                            'tr' => ['sentence' => 'öğretmen memnun', 'correct' => ['öğretmen', 'memnun'], 'extra' => ['sakin']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'az yorğun', 'correct' => ['az', 'yorğun'], 'extra' => ['çünki', 'həkim']],
                            'ar' => ['sentence' => 'قليل متعب', 'correct' => ['قليل', 'متعب'], 'extra' => ['لأن', 'طبيب']],
                            'ru' => ['sentence' => 'немного усталый', 'correct' => ['немного', 'усталый'], 'extra' => ['потому что', 'врач']],
                            ...
                            'tr' => ['sentence' => 'biraz yorgun', 'correct' => ['biraz', 'yorgun'], 'extra' => ['çünkü', 'doktor']],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'çünki mən xəstə', 'correct' => ['çünki', 'mən', 'xəstə'], 'extra' => ['az']],
                            'ar' => ['sentence' => 'لأن أنا مريض', 'correct' => ['لأن', 'أنا', 'مريض'], 'extra' => ['قليل']],
                            'ru' => ['sentence' => 'потому что я больной', 'correct' => ['потому что', 'я', 'больной'], 'extra' => ['немного']],
                            'es' => ['sentence' => 'Porque soy enfermo', 'correct' => ['porque', 'soy', 'enfermo'], 'extra' => ['un poco']],
                            'de' => ['sentence' => 'Weil ich krank bin', 'correct' => ['weil', 'ich krank', 'bin'], 'extra' => ['ein wenig']],
                            'ja' => ['sentence' => 'なぜなら私は病気です', 'correct' => ['なぜなら', '私', 'は', '病気', 'です'], 'extra' => ['少し']],
                            'ko' => ['sentence' => '왜냐하면 저는 아픕니다', 'correct' => ['왜냐하면', '저는', '아픕니다'], 'extra' => ['조금']],
                            'tr' => ['sentence' => 'çünkü hastayım', 'correct' => ['çünkü', 'hastayım'], 'extra' => ['biraz']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'həkim və mənim dost', 'correct' => ['həkim', 'və', 'mənim', 'dost'], 'extra' => ['xəstə']],
                            'ar' => ['sentence' => 'طبيب و صديق', 'correct' => ['طبيب', 'و', 'صديق'], 'extra' => ['مريض']],
                            'ru' => ['sentence' => 'врач и мой друг', 'correct' => ['врач', 'и', 'мой', 'друг'], 'extra' => ['больной']],
                            ...
                            'tr' => ['sentence' => 'doktor ve arkadaşım', 'correct' => ['doktor', 've', 'arkadaşım'], 'extra' => ['hasta']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mən xoşbəxt bu gün', 'correct' => ['mən', 'xoşbəxt', 'bu gün'], 'extra' => ['yorğun']],
                            'ar' => ['sentence' => 'أنا فرح اليوم', 'correct' => ['أنا', 'فرح', 'اليوم'], 'extra' => ['متعب']],
                            'ru' => ['sentence' => 'я счастливый сегодня', 'correct' => ['я', 'счастливый', 'сегодня'], 'extra' => ['усталый']],
                            ...
                            'tr' => ['sentence' => 'ben bugün mutluyum', 'correct' => ['ben', 'bugün', 'mutluyum'], 'extra' => ['yorgun']],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mənim ata yorğun', 'correct' => ['mənim', 'ata', 'yorğun'], 'extra' => ['xoşbəxt']],
                            'ar' => ['sentence' => 'أب متعب', 'correct' => ['أب', 'متعب'], 'extra' => ['فرح']],
                            'ru' => ['sentence' => 'мой папа усталый', 'correct' => ['мой', 'папа', 'усталый'], 'extra' => ['счастливый']],
                            ...
                            'tr' => ['sentence' => 'babam yorgun', 'correct' => ['babam', 'yorgun'], 'extra' => ['mutlu']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'mənim ana və mənim ata', 'correct' => ['mənim', 'ana', 'və', 'mənim', 'ata'], 'extra' => ['xoşbəxt']],
                            'ar' => ['sentence' => 'أم و أب', 'correct' => ['أم', 'و', 'أب'], 'extra' => ['فرح']],
                            'ru' => ['sentence' => 'мой мама и мой папа', 'correct' => ['мой', 'мама', 'и', 'мой', 'папа'], 'extra' => ['счастливый']],
                            ...
                            'tr' => ['sentence' => 'annem ve babam', 'correct' => ['annem', 've', 'babam'], 'extra' => ['mutlu']],
                        ],
                    ],
                ],
            ),
