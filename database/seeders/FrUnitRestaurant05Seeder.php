                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'tort dadlı', 'correct' => ['tort', 'dadlı'], 'extra' => ['əla', 'qəhvə']],
                            'ar' => ['sentence' => 'كعكة لذيذ', 'correct' => ['كعكة', 'لذيذ'], 'extra' => ['ممتاز', 'قهوة']],
                            'ru' => ['sentence' => 'торт вкусный', 'correct' => ['торт', 'вкусный'], 'extra' => ['отлично', 'кофе']],
                            ...
                            'tr' => ['sentence' => 'pasta lezzetli', 'correct' => ['pasta', 'lezzetli'], 'extra' => ['mükemmel', 'kahve']],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'qəhvə əla', 'correct' => ['qəhvə', 'əla'], 'extra' => ['dadlı', 'tort']],
                            'ar' => ['sentence' => 'قهوة ممتاز', 'correct' => ['قهوة', 'ممتاز'], 'extra' => ['لذيذ', 'كعكة']],
                            'ru' => ['sentence' => 'кофе отлично', 'correct' => ['кофе', 'отлично'], 'extra' => ['вкусный', 'торт']],
                            ...
                            'tr' => ['sentence' => 'kahve mükemmel', 'correct' => ['kahve', 'mükemmel'], 'extra' => ['lezzetli', 'pasta']],
                        ],
                    ],
                    'c' => [
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'düyü də duzlu', 'correct' => ['düyü', 'də', 'duzlu'], 'extra' => ['acılı', 'toyuq']],
                            'ar' => ['sentence' => 'أرز أيضا مالح', 'correct' => ['أرز', 'أيضا', 'مالح'], 'extra' => ['حار', 'دجاج']],
                            'ru' => ['sentence' => 'рис тоже солёный', 'correct' => ['рис', 'тоже', 'солёный'], 'extra' => ['острый', 'курица']],
                            ...
                            'tr' => ['sentence' => 'pirinç çok tuzlu', 'correct' => ['pirinç', 'çok', 'tuzlu'], 'extra' => ['acılı', 'tavuk']],
                        ],
                    ],
                    'b' => [
                    ...
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir duzlu düyü və bir acılı toyuq', 'correct' => ['bir', 'duzlu', 'düyü', 'və', 'bir', 'acılı', 'toyuq'], 'extra' => ['də']],
                            'ar' => ['sentence' => 'مالح أرز و حار دجاج', 'correct' => ['مالح', 'أرز', 'و', 'حار', 'دجاج'], 'extra' => ['أيضا']],
                            'ru' => ['sentence' => 'солёный рис и острый курица', 'correct' => ['солёный', 'рис', 'и', 'острый', 'курица'], 'extra' => ['тоже']],
                            ...
                            'tr' => ['sentence' => 'tuzlu bir pirinç ve acılı bir tavuk', 'correct' => ['tuzlu', 'bir', 'pirinç', 've', 'acılı', 'bir', 'tavuk'], 'extra' => ['de']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'balıq soyuq', 'correct' => ['balıq', 'soyuq'], 'extra' => ['problem', 'boşqab']],
                            'ar' => ['sentence' => 'سمك بارد', 'correct' => ['سمك', 'بارد'], 'extra' => ['مشكلة', 'صحن']],
                            'ru' => ['sentence' => 'рыба холодный', 'correct' => ['рыба', 'холодный'], 'extra' => ['проблема', 'тарелка']],
                            ...
                            'tr' => ['sentence' => 'balık soğuk', 'correct' => ['balık', 'soğuk'], 'extra' => ['sorun', 'tabak']],
                        ],
                    ],
                    'b' => [
                    ...
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir boşqab və bir problem', 'correct' => ['bir', 'boşqab', 'və', 'bir', 'problem'], 'extra' => ['soyuq', 'balıq']],
                            'ar' => ['sentence' => 'صحن و مشكلة', 'correct' => ['صحن', 'و', 'مشكلة'], 'extra' => ['بارد', 'سمك']],
                            'ru' => ['sentence' => 'тарелка и проблема', 'correct' => ['тарелка', 'и', 'проблема'], 'extra' => ['холодный', 'рыба']],
                            ...
                            'tr' => ['sentence' => 'bir tabak ve bir sorun', 'correct' => ['bir', 'tabak', 've', 'bir', 'sorun'], 'extra' => ['soğuk', 'balık']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'stəkan təmiz', 'correct' => ['stəkan', 'təmiz'], 'extra' => ['çirkli', 'boşqab']],
                            'ar' => ['sentence' => 'كوب نظيف', 'correct' => ['كوب', 'نظيف'], 'extra' => ['متسخ', 'صحن']],
                            'ru' => ['sentence' => 'стакан чистый', 'correct' => ['стакан', 'чистый'], 'extra' => ['грязный', 'тарелка']],
                            ...
                            'tr' => ['sentence' => 'bardak temiz', 'correct' => ['bardak', 'temiz'], 'extra' => ['kirli', 'tabak']],
                        ],
                    ],
                    'b' => [
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'qəhvə mükəmməl', 'correct' => ['qəhvə', 'mükəmməl'], 'extra' => ['dad', 'tort']],
                            'ar' => ['sentence' => 'قهوة مثالي', 'correct' => ['قهوة', 'مثالي'], 'extra' => ['مذاق', 'كعكة']],
                            'ru' => ['sentence' => 'кофе идеально', 'correct' => ['кофе', 'идеально'], 'extra' => ['вкус', 'торт']],
                            ...
                            'tr' => ['sentence' => 'kahve mükemmel', 'correct' => ['kahve', 'mükemmel'], 'extra' => ['tat', 'pasta']],
                        ],
                    ],
                    'b' => [
