...
class ArUnitRestaurant03Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'الحساب' => 'bill', 'قهوة' => 'coffee', 'بطاقة' => 'card', 'شاي' => 'tea',
        'ماء' => 'water', 'حليب' => 'milk', 'خبز' => 'bread', 'جبن' => 'cheese',
    ];

    /**
     * Arabic Restaurant Unit 3.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: The Bill Please', 1,
                pictures: [['ar' => 'الحساب', 'img' => 'bill'], ['ar' => 'قهوة', 'img' => 'coffee']],
            ...
            $builder->lesson('Lesson 3: Paying Together', 3,
                pictures: [['ar' => 'الحساب', 'img' => 'bill'], ['ar' => 'قهوة', 'img' => 'coffee']],
                plain: [['ar' => 'ندفع'], ['ar' => 'معا']],
                phrases: [
                    'a' => [
                        'words' => ['ندفع', 'معا'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Settling Up', 5,
                pictures: [['ar' => 'الحساب', 'img' => 'bill'], ['ar' => 'بطاقة', 'img' => 'card']],
                plain: [['ar' => 'أدفع'], ['ar' => 'مع']],
                phrases: [
                    'a' => [
                        'words' => ['أدفع', 'الحساب', 'مع', 'بطاقة'], 'blank' => 1,
                        'means' => [
