...
class RuUnitBeginner06Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Парк' => 'park', 'Магазин' => 'shop', 'Большой' => 'big', 'Улица' => 'street',
        'Идти' => 'park', 'Друг' => 'friend', 'Кофе' => 'coffee', 'Чай' => 'tea',
    ];

    /**
     * Russian Beginner Unit 6.
     *
    ...
    private function lessonsData(RussianLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Park & Shop', 1,
                pictures: [['ru' => 'Парк', 'img' => 'park'], ['ru' => 'Магазин', 'img' => 'shop']],
                plain: [['ru' => 'Это'], ['ru' => 'Может быть']],
                phrases: [
                    'a' => [
                        'words' => ['это', 'парк'], 'blank' => 1,
                        'means' => [
                            ...
                            'ar' => ['sentence' => 'هذا حديقة', 'correct' => ['هذا', 'حديقة'], 'extra' => ['متجر', 'و']],
                    ...
                    'b' => [
                        ...
                        'means' => [
                            ...
                            'ar' => ['sentence' => 'هذا متجر', 'correct' => ['هذا', 'متجر'], 'extra' => ['حديقة', 'و']],
            ...
            $builder->lesson('Lesson 2: Street & Station', 2,
                pictures: [['ru' => 'Большой', 'img' => 'big'], ['ru' => 'Улица', 'img' => 'street']],
                plain: [['ru' => 'Маленький'], ['ru' => 'Станция']],
                phrases: [
                    'a' => [
                        'words' => ['большой', 'улица'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['маленький', 'станция'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Going to the Park', 3,
                pictures: [['ru' => 'Идти', 'img' => 'park'], ['ru' => 'Парк', 'img' => 'park']],
                plain: [['ru' => 'Дома'], ['ru' => 'Может быть']],
                phrases: [
                    'a' => [
                        'words' => ['идти', 'в', 'парк'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['идти', 'в', 'парк', 'и', 'дома'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Going to School', 4,
                pictures: [['ru' => 'Идти', 'img' => 'park'], ['ru' => 'Магазин', 'img' => 'shop']],
                plain: [['ru' => 'Школу'], ['ru' => 'Может быть']],
                phrases: [
                    'a' => [
                        'words' => ['идти', 'в', 'школу'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['идти', 'в', 'школу', 'и', 'в', 'магазин'], 'blank' => 5,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Around Town', 5,
                pictures: [['ru' => 'Большой', 'img' => 'big'], ['ru' => 'Друг', 'img' => 'friend']],
                plain: [['ru' => 'Станция'], ['ru' => 'Мой']],
                phrases: [
                    'a' => [
                        'words' => ['большой', 'станция'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['мой', 'друг', 'идти', 'в', 'парк'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['улица', 'и', 'станция', 'большой'], 'blank' => 2,
                        'means' => [
