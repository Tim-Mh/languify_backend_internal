...
class AzUnitConversation06Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Kinoteatr' => 'cinema', 'Park' => 'park', 'Qəhvə' => 'coffee', 'Çay' => 'tea',
        'Su' => 'water', 'Süd' => 'milk', 'Çörək' => 'bread', 'Pendir' => 'cheese',
    ];

    /**
     * Azerbaijani Conversation Unit 6.
     *
    ...
    private function lessonsData(AzerbaijaniLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Tomorrow & I Will Go', 1,
                pictures: [['az' => 'Kinoteatr', 'img' => 'cinema'], ['az' => 'Park', 'img' => 'park']],
                plain: [['az' => 'Sabah'], ['az' => 'Gedəcəyəm']],
                phrases: [
                    'a' => [
                        'words' => ['sabah', 'gedəcəyəm', 'kinoteatra'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['bir', 'kinoteatr', 'və', 'bir', 'park'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: I Will Come & Next Week', 2,
                ...
                plain: [['az' => 'Gələn həftə'], ['az' => 'Gələcəyəm']],
                phrases: [
                    'a' => [
                        'words' => ['gələn həftə', 'gələcəyəm'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['gələcəyəm', 'evdəyəm'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['gedəcəyəm', 'məktəbə'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Together & With My Friend', 3,
                pictures: [['az' => 'Qəhvə', 'img' => 'coffee'], ['az' => 'Çay', 'img' => 'tea']],
                plain: [['az' => 'Gedəcəyəm'], ['az' => 'Dostumla']],
                phrases: [
                    'a' => [
                        'words' => ['gedəcəyəm', 'dostumla'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['birlikdə', 'gedəcəyik', 'kinoteatra'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['birlikdə', 'dostumla'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: I Will Do & I Will See', 4,
                pictures: [['az' => 'Qəhvə', 'img' => 'coffee'], ['az' => 'Çay', 'img' => 'tea']],
                plain: [['az' => 'Sabah'], ['az' => 'Edəcəyəm']],
                phrases: [
                    'a' => [
                        'words' => ['sabah', 'edəcəyəm', 'o'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['görəcəyəm', 'parkda'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Making a Plan', 5,
                pictures: [['az' => 'Qəhvə', 'img' => 'coffee'], ['az' => 'Çay', 'img' => 'tea']],
                plain: [['az' => 'Nə'], ['az' => 'Edəcəyəm']],
                phrases: [
                    'a' => [
                        'words' => ['nə', 'edəcəyəm', 'sabah'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['edəcəyəm', 'bir', 'plan'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['gələn həftə', 'gedəcəyəm', 'kinoteatra', 'dostumla'], 'blank' => 0,
                        'means' => [
