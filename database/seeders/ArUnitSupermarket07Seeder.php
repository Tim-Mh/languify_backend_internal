...
class ArUnitSupermarket07Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'تفاحة' => 'apple', 'حليب' => 'milk', 'خبز' => 'bread', 'جبن' => 'cheese',
        'قهوة' => 'coffee', 'شاي' => 'tea', 'ماء' => 'water', 'كعكة' => 'cake',
    ];

    /**
     * Arabic Supermarket Unit 7.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            ...
            $builder->lesson('Lesson 2: On Offer', 2,
                ...
                plain: [['ar' => 'بخصم'], ['ar' => 'يوجد']],
                phrases: [
                    'a' => [
                        'words' => ['خبز', 'بخصم'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Cheaper', 3,
                ...
                plain: [['ar' => 'أرخص'], ['ar' => 'أغلى']],
                phrases: [
                    'a' => [
                        'words' => ['تفاحة', 'أرخص'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['هذا', 'الأرخص'], 'blank' => 1,
                        'means' => [
                            'en' => ['sentence' => 'This is The cheapest', 'correct' => ['this is', 'the cheapest'], 'extra' => ['expensive']],
                            'az' => ['sentence' => 'bu ən ucuz', 'correct' => ['bu', 'ən ucuz'], 'extra' => ['bahalı']],
            ...
            $builder->lesson('Lesson 5: A Good Deal', 5,
                pictures: [['ar' => 'تفاحة', 'img' => 'apple'], ['ar' => 'جبن', 'img' => 'cheese']],
                plain: [['ar' => 'بخصم'], ['ar' => 'جدا']],
                phrases: [
                    'a' => [
                        'words' => ['تفاحة', 'بخصم', 'و', 'جدا', 'رخيص'], 'blank' => 0,
                        'means' => [
