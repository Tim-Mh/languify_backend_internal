...
class ArUnitRestaurant09Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'قهوة' => 'coffee', 'شاي' => 'tea', 'طاولة' => 'table', 'ماء' => 'water',
        'حليب' => 'milk', 'خبز' => 'bread', 'جبن' => 'cheese', 'كعكة' => 'cake',
    ];

    /**
     * Arabic Restaurant Unit 9.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Fork & Knife', 1,
                ...
                plain: [['ar' => 'لا يوجد'], ['ar' => 'شوكة']],
                phrases: [
                    'a' => [
                        'words' => ['لا يوجد', 'شوكة'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Spoon & Plate', 2,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'لا يوجد'], ['ar' => 'ملعقة']],
                phrases: [
                    'a' => [
                        'words' => ['لا يوجد', 'ملعقة'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Glass & Napkin', 3,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'كوب'], ['ar' => 'الماء']],
                phrases: [
                    'a' => [
                        'words' => ['كوب', 'الماء'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Everything We Need', 5,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'شوكة'], ['ar' => 'سكين']],
                phrases: [
                    'a' => [
                        'words' => ['شوكة', 'و', 'سكين'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['صحن', 'و', 'ملعقة', 'من فضلك'], 'blank' => 3,
                        'means' => [
