...
{
    private const LANGS = ['en', 'fr', 'es', 'de', 'ja', 'ko'];
    ...
    {
        return [
            ['c' => 1, 'o' => ['54', '56', '64', '48'], 'tr' => ['en' => 'What is 7 × 8?', 'fr' => 'Combien font 7 × 8 ?', 'es' => '¿Cuánto es 7 × 8?', 'de' => 'Was ist 7 × 8?', 'ja' => '7 × 8 は？', 'ko' => '7 × 8은?']],
            ['c' => 2, 'o' => ['6', '7', '8', '9'], 'tr' => ['en' => 'What is the square root of 64?', 'fr' => 'Quelle est la racine carrée de 64 ?', 'es' => '¿Cuál es la raíz cuadrada de 64?', 'de' => 'Was ist die Quadratwurzel von 64?', 'ja' => '64 の平方根は？', 'ko' => '64의 제곱근은?']],
            ['c' => 1, 'o' => ['5', '6', '7', '8'], 'tr' => ['en' => 'How many sides does a hexagon have?', 'fr' => 'Combien de côtés a un hexagone ?', 'es' => '¿Cuántos lados tiene un hexágono?', 'de' => 'Wie viele Seiten hat ein Sechseck?', 'ja' => '六角形の辺の数は？', 'ko' => '육각형의 변은 몇 개인가요?']],
            ['c' => 2, 'o' => ['20', '25', '30', '35'], 'tr' => ['en' => 'What is 15% of 200?', 'fr' => 'Combien font 15 % de 200 ?', 'es' => '¿Cuánto es el 15 % de 200?', 'de' => 'Was sind 15 % von 200?', 'ja' => '200 の 15% は？', 'ko' => '200의 15%는?']],
            ['c' => 1, 'o' => ['2', '3', '4', '6'], 'tr' => ['en' => 'What is 12 ÷ 4?', 'fr' => 'Combien font 12 ÷ 4 ?', 'es' => '¿Cuánto es 12 ÷ 4?', 'de' => 'Was ist 12 ÷ 4?', 'ja' => '12 ÷ 4 は？', 'ko' => '12 ÷ 4는?']],
            ['c' => 1, 'o' => ['90°', '180°', '270°', '360°'], 'tr' => ['en' => 'What is the sum of the angles in a triangle?', 'fr' => "Quelle est la somme des angles d'un triangle ?", 'es' => '¿Cuál es la suma de los ángulos de un triángulo?', 'de' => 'Was ist die Summe der Winkel in einem Dreieck?', 'ja' => '三角形の内角の和は？', 'ko' => '삼각형의 내각의 합은?']],
            ['c' => 2, 'o' => ['18', '72', '81', '99'], 'tr' => ['en' => 'What is 9 squared?', 'fr' => 'Combien font 9 au carré ?', 'es' => '¿Cuánto es 9 al cuadrado?', 'de' => 'Was ist 9 zum Quadrat?', 'ja' => '9 の 2 乗は？', 'ko' => '9의 제곱은?']],
            ['c' => 3, 'o' => ['20', '24', '30', '32'], 'tr' => ['en' => 'What number comes next: 2, 4, 8, 16, ...?', 'fr' => 'Quel nombre vient ensuite : 2, 4, 8, 16, ... ?', 'es' => '¿Qué número sigue: 2, 4, 8, 16, ...?', 'de' => 'Welche Zahl kommt als Nächstes: 2, 4, 8, 16, ...?', 'ja' => '次に来る数は：2, 4, 8, 16, ...？', 'ko' => '다음에 올 숫자는: 2, 4, 8, 16, ...?']],
            ['c' => 0, 'o' => ['63', '67', '73', '53'], 'tr' => ['en' => 'What is 100 − 37?', 'fr' => 'Combien font 100 − 37 ?', 'es' => '¿Cuánto es 100 − 37?', 'de' => 'Was ist 100 − 37?', 'ja' => '100 − 37 は？', 'ko' => '100 − 37은?']],
            ['c' => 2, 'o' => ['100', '110', '120', '90'], 'tr' => ['en' => 'How many minutes are in 2 hours?', 'fr' => 'Combien de minutes y a-t-il dans 2 heures ?', 'es' => '¿Cuántos minutos hay en 2 horas?', 'de' => 'Wie viele Minuten sind in 2 Stunden?', 'ja' => '2 時間は何分ですか？', 'ko' => '2시간은 몇 분인가요?']],
            ['c' => 3, 'o' => ['25', '60', '100', '120'], 'tr' => ['en' => 'What is 5 factorial (5!)?', 'fr' => 'Combien font 5 factorielle (5!) ?', 'es' => '¿Cuánto es 5 factorial (5!)?', 'de' => 'Was ist 5 Fakultät (5!)?', 'ja' => '5 の階乗 (5!) は？', 'ko' => '5 팩토리얼(5!)은?']],
            ['c' => 2, 'o' => ['34%', '43%', '75%', '60%'], 'tr' => ['en' => 'What is 3/4 written as a percentage?', 'fr' => 'Comment écrit-on 3/4 en pourcentage ?', 'es' => '¿Cómo se escribe 3/4 como porcentaje?', 'de' => 'Wie schreibt man 3/4 als Prozentsatz?', 'ja' => '3/4 をパーセントで表すと？', 'ko' => '3/4을 백분율로 나타내면?']],
        ];
    }
