...
class RuUnitBeginner09Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Солнце' => 'sun', 'Дождь' => 'rain', 'Снег' => 'snow', 'Ветер' => 'wind',
        'Лето' => 'summer', 'Зима' => 'winter', 'Идти' => 'park', 'Парк' => 'park',
    ];

    /**
     * Russian Beginner Unit 9.
     *
    ...
    private function lessonsData(RussianLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Sun & Rain', 1,
                pictures: [['ru' => 'Солнце', 'img' => 'sun'], ['ru' => 'Дождь', 'img' => 'rain']],
                plain: [['ru' => 'Сегодня'], ['ru' => 'Может быть']],
                phrases: [
                    'a' => [
                        'words' => ['солнце', 'сегодня'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: Snow & Wind', 2,
                pictures: [['ru' => 'Снег', 'img' => 'snow'], ['ru' => 'Ветер', 'img' => 'wind']],
                plain: [['ru' => 'Сегодня'], ['ru' => 'Холодный']],
                phrases: [
                    'a' => [
                        'words' => ['снег', 'сегодня'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['сегодня', 'холодный'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['снег', 'и', 'ветер', 'сегодня'], 'blank' => 3,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Summer & Winter', 3,
                pictures: [['ru' => 'Лето', 'img' => 'summer'], ['ru' => 'Зима', 'img' => 'winter']],
                plain: [['ru' => 'Горячий'], ['ru' => 'Холодный']],
                phrases: [
                    'a' => [
                        'words' => ['лето', 'горячий'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['лето', 'горячий', 'и', 'зима', 'холодный'], 'blank' => 4,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Spring & Autumn', 4,
                pictures: [['ru' => 'Лето', 'img' => 'summer'], ['ru' => 'Дождь', 'img' => 'rain']],
                plain: [['ru' => 'Весна'], ['ru' => 'Осень']],
                phrases: [
                    'a' => [
                        'words' => ['весна', 'и', 'лето'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['весна', 'и', 'осень', 'день'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: The Weather', 5,
                ...
                plain: [['ru' => 'Сегодня'], ['ru' => 'Горячий']],
                phrases: [
                    'a' => [
                        'words' => ['сегодня', 'горячий'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['идти', 'в', 'парк', 'летом'], 'blank' => 3,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['солнце', 'сегодня', 'и', 'дождь', 'завтра'], 'blank' => 1,
                        'means' => [
