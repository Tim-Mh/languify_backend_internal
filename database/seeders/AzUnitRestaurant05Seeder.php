...
class AzUnitRestaurant05Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Yemək' => 'eat', 'Şorba' => 'soup', 'Qəhvə' => 'coffee', 'Ət' => 'meat',
        'Çay' => 'tea', 'Su' => 'water', 'Süd' => 'milk', 'Çörək' => 'bread',
    ];

    /**
     * Azerbaijani Restaurant Unit 5.
     *
    ...
    private function lessonsData(AzerbaijaniLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: It Is Delicious', 1,
                pictures: [['az' => 'Yemək', 'img' => 'eat'], ['az' => 'Şorba', 'img' => 'soup']],
                plain: [['az' => 'Dadlı'], ['az' => 'Çox']],
                phrases: [
                    'a' => [
            ...
            $builder->lesson('Lesson 2: It Is Cold', 2,
                pictures: [['az' => 'Yemək', 'img' => 'eat'], ['az' => 'Qəhvə', 'img' => 'coffee']],
                plain: [['az' => 'Soyuq'], ['az' => 'Balığı']],
                phrases: [
                    'a' => [
                        'words' => ['yemək', 'soyuq'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Too Salty', 3,
                ...
                plain: [['az' => 'Duzlu'], ['az' => 'Çox']],
                phrases: [
                    'a' => [
                        'words' => ['şorba', 'duzlu'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['yemək', 'deyil', 'dadlı'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Saying It Politely', 5,
                ...
                phrases: [
                    ...
                    'b' => [
                        'words' => ['şorba', 'deyil', 'soyuq'], 'blank' => 0,
                        'means' => [
