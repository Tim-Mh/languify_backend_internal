...
class AzUnitRestaurant01Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Şorba' => 'soup', 'Salat' => 'salad', 'Balıq' => 'fish', 'Ət' => 'meat',
        'Menyu' => 'menu', 'Çörək' => 'bread', 'Qəhvə' => 'coffee', 'Çay' => 'tea',
    ];

    /**
     * Azerbaijani Restaurant Unit 1.
     *
    ...
    private function lessonsData(AzerbaijaniLessonBuilder $builder): array
    {
        return [
            ...
            $builder->lesson('Lesson 2: Fish & Meat', 2,
                ...
                plain: [['az' => 'İstəyirəm'], ['az' => 'Zəhmət olmasa']],
                phrases: [
                    'a' => [
                        'words' => ['istəyirəm', 'balıq'], 'blank' => 0,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['balıq', 'zəhmət olmasa'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: The Menu', 3,
                pictures: [['az' => 'Menyu', 'img' => 'menu'], ['az' => 'Çörək', 'img' => 'bread']],
                plain: [['az' => 'Zəhmət olmasa'], ['az' => 'Bir']],
                phrases: [
                    'a' => [
                    ...
                    'b' => [
                        'words' => ['bir', 'porsiya', 'balığın'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: Calling the Waiter', 4,
                ...
                plain: [['az' => 'Ofisiant'], ['az' => 'Zəhmət olmasa']],
                phrases: [
                    'a' => [
                        'words' => ['ofisiant', 'zəhmət olmasa'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['istəyirəm', 'sifariş vermək'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['bir', 'ət', 'zəhmət olmasa'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: A Full Order', 5,
                ...
                phrases: [
                    'a' => [
                        'words' => ['istəyirəm', 'bir', 'şorba', 'və', 'bir', 'salat'], 'blank' => 0,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['balıq', 'və', 'çörək', 'zəhmət olmasa'], 'blank' => 3,
                        'means' => [
