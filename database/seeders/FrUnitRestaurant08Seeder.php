                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir tort ilə şokolad', 'correct' => ['bir', 'tort', 'ilə', 'şokolad'], 'extra' => ['dilim', 'dondurma']],
                            'ar' => ['sentence' => 'كعكة مع شوكولاتة', 'correct' => ['كعكة', 'مع', 'شوكولاتة'], 'extra' => ['شريحة', 'آيس كريم']],
                            'ru' => ['sentence' => 'торт с шоколад', 'correct' => ['торт', 'с', 'шоколад'], 'extra' => ['кусок', 'мороженое']],
                    ...
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir dondurma ilə şokolad', 'correct' => ['bir', 'dondurma', 'ilə', 'şokolad'], 'extra' => ['dilim', 'tort']],
                            'ar' => ['sentence' => 'آيس كريم مع شوكولاتة', 'correct' => ['آيس كريم', 'مع', 'شوكولاتة'], 'extra' => ['شريحة', 'كعكة']],
                            'ru' => ['sentence' => 'мороженое с шоколад', 'correct' => ['мороженое', 'с', 'шоколад'], 'extra' => ['кусок', 'торт']],
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bölüşmək bir ekler', 'correct' => ['bölüşmək', 'bir', 'ekler'], 'extra' => ['qaymaq', 'kruassan']],
                            'ar' => ['sentence' => 'المشاركة إكلير', 'correct' => ['المشاركة', 'إكلير'], 'extra' => ['كريمة', 'كرواسون']],
                            'ru' => ['sentence' => 'разделить эклер', 'correct' => ['разделить', 'эклер'], 'extra' => ['сливки', 'круассан']],
                            ...
                            'tr' => ['sentence' => 'bir ekler paylaşmak', 'correct' => ['bir', 'ekler', 'paylaşmak'], 'extra' => ['krema', 'kruvasan']],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir kruassan ilə qaymaq', 'correct' => ['bir', 'kruassan', 'ilə', 'qaymaq'], 'extra' => ['bölüşmək', 'ekler']],
                            'ar' => ['sentence' => 'كرواسون مع كريمة', 'correct' => ['كرواسون', 'مع', 'كريمة'], 'extra' => ['المشاركة', 'إكلير']],
                            'ru' => ['sentence' => 'круассан с сливки', 'correct' => ['круассан', 'с', 'сливки'], 'extra' => ['разделить', 'эклер']],
                            ...
                            'tr' => ['sentence' => 'kremalı bir kruvasan', 'correct' => ['kremalı', 'bir', 'kruvasan'], 'extra' => ['paylaşmak', 'ekler']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bölüşmək bir kruassan və bir ekler', 'correct' => ['bölüşmək', 'bir', 'kruassan', 'və', 'bir', 'ekler'], 'extra' => ['qaymaq']],
                            'ar' => ['sentence' => 'المشاركة كرواسون و إكلير', 'correct' => ['المشاركة', 'كرواسون', 'و', 'إكلير'], 'extra' => ['كريمة']],
                            'ru' => ['sentence' => 'разделить круассан и эклер', 'correct' => ['разделить', 'круассан', 'и', 'эклер'], 'extra' => ['сливки']],
                            ...
                            'tr' => ['sentence' => 'bir kruvasan ve bir ekler paylaşmak', 'correct' => ['bir', 'kruvasan', 've', 'bir', 'ekler', 'paylaşmak'], 'extra' => ['krema']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir dondurma ilə vanil', 'correct' => ['bir', 'dondurma', 'ilə', 'vanil'], 'extra' => ['çiyələk', 'alma']],
                            'ar' => ['sentence' => 'آيس كريم مع فانيليا', 'correct' => ['آيس كريم', 'مع', 'فانيليا'], 'extra' => ['فراولة', 'تفاحة']],
                            'ru' => ['sentence' => 'мороженое с ванильный', 'correct' => ['мороженое', 'с', 'ванильный'], 'extra' => ['клубничный', 'яблоко']],
                    ...
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir alma və ya bir çiyələk', 'correct' => ['bir', 'alma', 'və ya', 'bir', 'çiyələk'], 'extra' => ['vanil', 'dondurma']],
                            'ar' => ['sentence' => 'تفاحة أو فراولة', 'correct' => ['تفاحة', 'أو', 'فراولة'], 'extra' => ['فانيليا', 'آيس كريم']],
                            'ru' => ['sentence' => 'яблоко или клубничный', 'correct' => ['яблоко', 'или', 'клубничный'], 'extra' => ['ванильный', 'мороженое']],
                            ...
                            'tr' => ['sentence' => 'bir elma veya bir çilek', 'correct' => ['bir', 'elma', 'veya', 'bir', 'çilek'], 'extra' => ['vanilya', 'dondurma']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'vanil və çiyələk', 'correct' => ['vanil', 'və', 'çiyələk'], 'extra' => ['alma', 'dondurma']],
                            'ar' => ['sentence' => 'فانيليا و فراولة', 'correct' => ['فانيليا', 'و', 'فراولة'], 'extra' => ['تفاحة', 'آيس كريم']],
                            'ru' => ['sentence' => 'ванильный и клубничный', 'correct' => ['ванильный', 'и', 'клубничный'], 'extra' => ['яблоко', 'мороженое']],
                            ...
                            'tr' => ['sentence' => 'vanilya ve çilek', 'correct' => ['vanilya', 've', 'çilek'], 'extra' => ['elma', 'dondurma']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir tart ilə alma', 'correct' => ['bir', 'tart', 'ilə', 'alma'], 'extra' => ['meyvə', 'tort']],
                            'ar' => ['sentence' => 'فطيرة مع تفاحة', 'correct' => ['فطيرة', 'مع', 'تفاحة'], 'extra' => ['فاكهة', 'كعكة']],
                            'ru' => ['sentence' => 'тарт с яблоко', 'correct' => ['тарт', 'с', 'яблоко'], 'extra' => ['фрукт', 'торт']],
                    ...
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir tart və bir tort', 'correct' => ['bir', 'tart', 'və', 'bir', 'tort'], 'extra' => ['meyvə', 'alma']],
                            'ar' => ['sentence' => 'فطيرة و كعكة', 'correct' => ['فطيرة', 'و', 'كعكة'], 'extra' => ['فاكهة', 'تفاحة']],
                            'ru' => ['sentence' => 'тарт и торт', 'correct' => ['тарт', 'и', 'торт'], 'extra' => ['фрукт', 'яблоко']],
                            ...
                            'tr' => ['sentence' => 'bir turta ve bir pasta', 'correct' => ['bir', 'turta', 've', 'bir', 'pasta'], 'extra' => ['meyve', 'elma']],
                        ],
                    ],
                ],
            ),
                ...
                phrases: [
                    'a' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir şirin ekler', 'correct' => ['bir', 'şirin', 'ekler'], 'extra' => ['kifayət', 'kruassan']],
                            'ar' => ['sentence' => 'حلو إكلير', 'correct' => ['حلو', 'إكلير'], 'extra' => ['كفى', 'كرواسون']],
                            'ru' => ['sentence' => 'сладкий эклер', 'correct' => ['сладкий', 'эклер'], 'extra' => ['достаточно', 'круассан']],
                            ...
                            'tr' => ['sentence' => 'tatlı bir ekler', 'correct' => ['tatlı', 'bir', 'ekler'], 'extra' => ['yeterli', 'kruvasan']],
                        ],
                    ],
                    'b' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir kruassan kifayət şirin', 'correct' => ['bir', 'kruassan', 'kifayət', 'şirin'], 'extra' => ['ekler']],
                            'ar' => ['sentence' => 'كرواسون كفى حلو', 'correct' => ['كرواسون', 'كفى', 'حلو'], 'extra' => ['إكلير']],
                            'ru' => ['sentence' => 'круассан достаточно сладкий', 'correct' => ['круассан', 'достаточно', 'сладкий'], 'extra' => ['эклер']],
                            ...
                            'tr' => ['sentence' => 'oldukça tatlı bir kruvasan', 'correct' => ['oldukça', 'tatlı', 'bir', 'kruvasan'], 'extra' => ['ekler']],
                        ],
                    ],
                    'c' => [
                        ...
                        'tr' => [
                            ...
                            'az' => ['sentence' => 'bir kruassan və bir şirin ekler', 'correct' => ['bir', 'kruassan', 'və', 'bir', 'şirin', 'ekler'], 'extra' => ['kifayət']],
                            'ar' => ['sentence' => 'كرواسون و حلو إكلير', 'correct' => ['كرواسون', 'و', 'حلو', 'إكلير'], 'extra' => ['كفى']],
                            'ru' => ['sentence' => 'круассан и сладкий эклер', 'correct' => ['круассан', 'и', 'сладкий', 'эклер'], 'extra' => ['достаточно']],
                            ...
                            'tr' => ['sentence' => 'bir kruvasan ve tatlı bir ekler', 'correct' => ['bir', 'kruvasan', 've', 'tatlı', 'bir', 'ekler'], 'extra' => ['yeterli']],
                        ],
                    ],
                ],
            ),
