...
class ArUnitConversation09Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'كتاب' => 'book', 'قهوة' => 'coffee', 'شاي' => 'tea', 'كبير' => 'big',
        'ماء' => 'water', 'حليب' => 'milk', 'خبز' => 'bread', 'جبن' => 'cheese',
    ];

    /**
     * Arabic Conversation Unit 9.
     *
    ...
    private function lessonsData(ArabicLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: In My Opinion', 1,
                ...
                plain: [['ar' => 'برأيي'], ['ar' => 'هذا']],
                phrases: [
                    'a' => [
                        'words' => ['برأيي', 'هذا', 'لطيف'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: I Think', 2,
                ...
                plain: [['ar' => 'أفكر'], ['ar' => 'إذن']],
                phrases: [
                    'a' => [
                        'words' => ['أفكر', 'إذن', 'أيضا'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: I Agree', 3,
                pictures: [['ar' => 'قهوة', 'img' => 'coffee'], ['ar' => 'شاي', 'img' => 'tea']],
                plain: [['ar' => 'نعم'], ['ar' => 'أوافق']],
                phrases: [
                    'a' => [
                        'words' => ['نعم', 'أوافق'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: About the City', 4,
                ...
                plain: [['ar' => 'هذا'], ['ar' => 'مدينة']],
                phrases: [
                    'a' => [
                        'words' => ['هذا', 'مدينة', 'لطيف'], 'blank' => 1,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['برأيي', 'مدينة', 'جدا', 'لطيف'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Saying It Together', 5,
                ...
                phrases: [
                    ...
                    'c' => [
                        'words' => ['نعم', 'برأيي', 'هذا', 'صحيح', 'أيضا'], 'blank' => 1,
                        'means' => [
