...
class TrUnitSupermarket07Seeder extends Seeder
{
    ...
    /**
     * Turkish Supermarket Unit 7 - what it costs and what is on offer.
     *
     * THE RULE THIS UNIT TEACHES: `-de` MARKS THE THING ON OFFER.
     *
     * `indirimde` is `indirim` plus the locative, and it means "on discount", the
     * same suffix that put things in aisles and on lists. Turkish is consistent
     * here in a way English is not: English swaps preposition by context (in the
     * aisle, on the list, on offer), Turkish uses one suffix for all three.
     *
     * Pointing that out is the whole value of putting prices this late in the
     * chapter: by now the learner has seen -da/-de six times, and this is the one
     * where it stops looking like a preposition and starts looking like a rule.
     */
    ...
    private function lessonsData(TurkishLessonBuilder $builder): array
    {
        return [
            ...
            $builder->lesson('Lesson 2: On Offer', 2,
                ...
                plain: [['tr' => 'İndirim'], ['tr' => 'Fiyat']],
                phrases: [
                    'a' => [
                        'words' => ['ekmek', 'indirimde'], 'blank' => 1,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['peynir', 'indirimde', 'değil'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: Cheaper', 3,
                ...
                plain: [['tr' => 'Ucuz'], ['tr' => 'Pahalı']],
                phrases: [
                    'a' => [
                        'words' => ['elma', 'daha', 'ucuz'], 'blank' => 2,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['ekmek', 'daha', 'pahalı'], 'blank' => 2,
                        'means' => [
                    ...
                    'c' => [
                        ...
                        'means' => [
                            ...
                            'ru' => ['sentence' => 'самый дешёвый', 'correct' => ['самый', 'дешёвый'], 'extra' => ['дорогой']],
            ...
            $builder->lesson('Lesson 5: A Good Deal', 5,
                pictures: [['tr' => 'Elma', 'img' => 'apple'], ['tr' => 'Peynir', 'img' => 'cheese']],
                plain: [['tr' => 'İndirim'], ['tr' => 'Ucuz']],
                phrases: [
                    'a' => [
                        'words' => ['elma', 'indirimde', 've', 'çok', 'ucuz'], 'blank' => 3,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['peynir', 'pahalı', 'değil'], 'blank' => 2,
                        'means' => [
