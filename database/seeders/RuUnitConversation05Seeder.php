...
class RuUnitConversation05Seeder extends Seeder
{
    /** Pictures this unit can offer as wrong answers. */
    private const PICTURES = [
        'Хлеб' => 'bread', 'Яблоко' => 'apple', 'Кофе' => 'coffee', 'Вода' => 'water',
        'Парк' => 'park', 'Дом' => 'house', 'Школа' => 'school', 'Магазин' => 'shop',
        'Друг' => 'friend',
    ];

    /**
     * Russian Conversation Unit 5.
     *
    ...
    private function lessonsData(RussianLessonBuilder $builder): array
    {
        return [
            $builder->lesson('Lesson 1: Yesterday & I Ate', 1,
                pictures: [['ru' => 'Хлеб', 'img' => 'bread'], ['ru' => 'Яблоко', 'img' => 'apple']],
                plain: [['ru' => 'Вчера'], ['ru' => 'Ел']],
                phrases: [
                    'a' => [
                        'words' => ['вчера', 'я', 'ел', 'хлеб'], 'blank' => 0,
                        'means' => [
            ...
            $builder->lesson('Lesson 2: I Drank & It Was', 2,
                pictures: [['ru' => 'Кофе', 'img' => 'coffee'], ['ru' => 'Вода', 'img' => 'water']],
                plain: [['ru' => 'Пил'], ['ru' => 'Было']],
                phrases: [
                    'a' => [
                        'words' => ['я', 'пил', 'кофе'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 3: I Saw & Already', 3,
                pictures: [['ru' => 'Парк', 'img' => 'park'], ['ru' => 'Дом', 'img' => 'house']],
                plain: [['ru' => 'Видел'], ['ru' => 'Уже']],
                phrases: [
                    'a' => [
                        'words' => ['я', 'видел', 'парк'], 'blank' => 1,
                        'means' => [
            ...
            $builder->lesson('Lesson 4: I Was & Then', 4,
                pictures: [['ru' => 'Школа', 'img' => 'school'], ['ru' => 'Магазин', 'img' => 'shop']],
                plain: [['ru' => 'Был'], ['ru' => 'Потом']],
                phrases: [
                    'a' => [
                        'words' => ['я', 'был', 'в', 'школа'], 'blank' => 3,
                        'means' => [
                    ...
                    'c' => [
                        'words' => ['я', 'был', 'здесь', 'потом'], 'blank' => 2,
                        'means' => [
            ...
            $builder->lesson('Lesson 5: Yesterday & Good', 5,
                ...
                plain: [['ru' => 'Вчера'], ['ru' => 'Было']],
                phrases: [
                    'a' => [
                        'words' => ['вчера', 'было', 'хороший'], 'blank' => 2,
                        'means' => [
                    ...
                    'b' => [
                        'words' => ['мой', 'друг', 'хороший'], 'blank' => 2,
                        'means' => [
